...
class Interceptor extends \MGS\Mpanel\Block\Products\Deals implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDealsByCategories');
        if (!$pluginInfo) {
            return parent::getDealsByCategories($categoryIds);
        } else {
            return $this->___callPlugins('getDealsByCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomClass');
        if (!$pluginInfo) {
            return parent::getCustomClass();
        } else {
            return $this->___callPlugins('getCustomClass', func_get_args(), $pluginInfo);
        }
    }
