<?php
namespace MGS\Mpanel\Block\Products\NewProducts;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Products\NewProducts
 */
class Interceptor extends \MGS\Mpanel\Block\Products\NewProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductCollection($category)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductCollection($category);
        } else {
     ...
     * {@inheritdoc}
     */
    public function getNewProductByCategories($categoryIds)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewProductByCategories');
        if (!$pluginInfo) {
            return parent::getNewProductByCategories($categoryIds);
        } else {
            return $this->___callPlugins('getNewProductByCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllProductCount');
        if (!$pluginInfo) {
            return parent::getAllProductCount();
        } else {
            return $this->___callPlugins('getAllProductCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsPerRow');
        if (!$pluginInfo) {
            return parent::getProductsPerRow();
        } else {
            return $this->___callPlugins('getProductsPerRow', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryByIds');
        if (!$pluginInfo) {
            return parent::getCategoryByIds();
        } else {
            return $this->___callPlugins('getCategoryByIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadProduct');
        if (!$pluginInfo) {
            return parent::getLoadProduct($id);
        } else {
            return $this->___callPlugins('getLoadProduct', func_get_args(), $pluginInfo);
        }
    }
