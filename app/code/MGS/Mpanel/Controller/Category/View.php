        ...
        if($this->getRequest()->isAjax()){
            ...
            if ($category) {
                ...
                if($this->_builderHelper->isActiveModule('MGS_Ajaxlayernavigation') && $this->getRequest()->getParam('is_ajax')==1){                
                    ...
                    $result = [
                        'list'    => $this->_view->getLayout()->getBlock('category.products')->toHtml(),
                        'filters' => $this->_view->getLayout()->getBlock('catalog.leftnav')->toHtml(),
                        'state'   => $this->_view->getLayout()->getBlock('catalog.navigation.state')->toHtml()
                    ];
